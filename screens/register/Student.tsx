    ...
    <View className='flex-1'>
      <KeyboardAvoidingView className='flex-1' behavior={Platform.OS === "ios" ? "padding" : "height"} keyboardVerticalOffset={Platform.OS === 'ios' ? 30 : 0}>
          <ScrollView showsVerticalScrollIndicator={false} className='flex-1'>
            ...
            <View className='w-full justify-center mt-6' style={{ paddingBottom: bottom + 20 }}>
        ...
        <Modals showModal={modalVisible}>
            <View>
                <TouchableOpacity className='ml-auto flex-row justify-end' onPress={() => setModalVisible(!modalVisible)}>
