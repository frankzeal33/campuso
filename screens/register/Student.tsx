  ...
  return (
    <View className="flex-1">
            ...
            <View className="w-full flex-row items-start gap-2 mt-7">
              ...
              <View className="flex-row flex-wrap flex-1 w-full -mt-1">
                <Text className="font-mregular">
                  By checking this box, you totally accept the{" "}
                </Text>
                <TouchableOpacity>
                  <Text className="text-green font-msbold">
                    terms & conditions
                  </Text>
                </TouchableOpacity>
      ...
      <Modals showModal={modalVisible}>
        <View>
          <TouchableOpacity
            className="ml-auto flex-row justify-end"
            onPress={() => setModalVisible(!modalVisible)}
          >
            <Ionicons name="close-circle-sharp" size={35} color="#C3C3C3" />
          </TouchableOpacity>
          ...
          <Text className="text-3xl text-center text-green -mt-4 font-rbold">
            Success!
          </Text>
          <Text className="text-base text-center mt-1 font-rlight mb-6">
            You have created a PIN
          </Text>
        </View>
      </Modals>
    </View>
